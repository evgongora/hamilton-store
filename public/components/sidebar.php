...
$menuItems = [
    ...
    ['key' => 'datos_auxiliares', 'label' => 'Direcciones y teléfonos', 'icon' => 'bi-telephone', 'url' => 'datos_auxiliares.php'],
    ['key' => 'gestion_stock', 'label' => 'Gestión de stock', 'icon' => 'bi-arrow-left-right', 'url' => 'gestion_stock.php'],
    ['key' => 'metodos_pago', 'label' => 'Métodos de pago', 'icon' => 'bi-wallet2', 'url' => 'metodos_pago.php'],
