<?php
/**
 * ubicaciones.php - Provincias, cantones y distritos
 * Requerimiento: Direcciones y Ubicación Geográfica
 */
...
<body class="app-layout bg-light">
    ...
    <div class="app-main">
        ...
        <main class="app-content">
            ...
            <p class="text-muted">Provincias, cantones y distritos para direcciones de clientes y proveedores. Módulo en desarrollo.</p>
        </main>
    </div>
